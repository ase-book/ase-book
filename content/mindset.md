...
That is the trap. Clean output makes it easy to assume the agent already figured the system out. It did not, and it still does not know your rules, constraints, or taste.
